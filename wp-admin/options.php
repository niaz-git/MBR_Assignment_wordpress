...
//=========================================================================================
			//update post table
			if( $option =="bloglistselect"){

//Get all posts and reset   simple alert => 0
...
$id = stripslashes_deep($post_id); //added stripslashes_deep which removes WP escaping.

$wpdb->update('wp_posts', array('simple_alert'=>0), array('id'=>$id));
    }
//Update simple_alert Fields =  1
				foreach ( $_POST["bloglistselect"] as $post_id ) {
				   $wpdb->update('wp_posts', array('simple_alert'=>1), array('id'=>$post_id));
				}
			}
//==================================================================================================
//------end  post table updation --
